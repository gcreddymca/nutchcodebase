...
import org.apache.hadoop.mapred.lib.db.CrestDBInputFormat;
  ...
  public static class InjectMapper implements Mapper<WritableComparable<?>, Text, Text, CrawlDatum> {
    ...
    public void map(WritableComparable<?> key, Text value,
      ...
      if(conf.getBoolean("url.exclude.request.parameters", false)){
    	  url = URLTransformationUtil.excludeRequestParameters(url);
      }
      
      if(conf.getBoolean("url.exclude.bookmarks", false)){
    	  url = URLTransformationUtil.excludeBookmarks(url);
		}
